                ...
                if ligation_bc_match in LIGwells_dict:
                    ...
                    if target_RT in RT_barcode_list:
                        ...
                        if barcode in RTsamplename_dict:
                            ...
                            first_line = f'@LIG-{ligindx}_RT-{RTwell},PCR-{pcrwell},{UMI},{samplename},{RTprimer}\n'
                            f3.write(first_line)
...
def attach_UMI_files(input_folder, pcrwell, output_folder, ligation_barcode_file, LIGlist, RT_barcode_file, RT_sample, core):
    ...
    with open(RT_sample, "r") as RTprimernames:
    ...
    func = partial(
        ...
        RT_barcode_list=RT_barcode_list, RTsamplename_dict=RTsamplename_dict, RTprimer_dict = RTprimer_dict, RTwells_dict=RTwells_dict, LIGwells_dict=LIGwells_dict, mismatch_rate=1
    )
